...
In order to understand the current faculty trends accross US institutions we decided to perform analysis on the table that we created for the year 2021. This table contained faculty data and institutional characteristics for 3586 different higher education institutions.
...
Most of the institutions in this dataset offer at least a 4 year Bachelor's degree, wich 68% of them doing so. 
...
We also looked at the trends displayed by the faculty's academic rank and tenure status. There were a few different trends we noticed when looking at this part of the data. First, the total number of faculty decreased as the academic rank increased, this was expected. The other trend we noticed was more interesting. The lower academic ranks showed a higher amount of male faculty but as the rank increased so did the percentage of female faculty. The lowest rank had 51% male faculty and 49% female faculty while the highest rank had 44% male faculty and 56% female faculty. 
